...
<link rel="stylesheet" href="css/generalStyle.css" type="text/css"
	media="screen">
<link rel="stylesheet" href="css/supportStyle.css" type="text/css"
	media="screen">
	...
	<div class="wrapper">
		<div class="main">
			<div class="section">
				...
				<form name="frm1" action="MainController" method="post">
					...
					<div class="input">
						<input class="inp_side" type="text" name="title">
					...
					<div class="input">
						<select class="inp_side" list="country" name="country"
							placeholder="${country}">
							<option value=""></option>
					...
					<div class="input">
						<input class="inp_side" type="number" name="year" min="1900"
							max="2050" step="1">
					</div>
					...
					<div class="input">
						<select class="inp_side" class="list" name="actor">
							<option value=""></option>
					...
					<div class="input">
						<select class="inp_side" class="list" name="producer">
							<option value=""></option>
					...
					<div class="input">
						<select class="inp_side" name="genre">
							<option value=""></option>
